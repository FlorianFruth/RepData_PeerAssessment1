...
hist(numbersteps_imp, breaks = 20, main = "Histogram of number of daily steps with imputed data set")
```
...
paste0("The mean using impute data is equal to ", meansteps_imp)
paste0("The median using impute data is equal to ", mediansteps_imp)
```
...
The median is rather robust regarding imputing which can be expected. The most drastic effect is the reduction of small values.

## Are there differences in activity patterns between weekdays and weekends?  
a) Creation of a new factor variable "flag_weekend" indicating whether the respective day belongs to the weekend or not. 
```{r}
